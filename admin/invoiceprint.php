	...
	<style>
		...
		*[contenteditable]:focus,
		...
		.cut {
			...
			background-image: -moz-linear-gradient(#00ADEE 5%,rgb(3, 165, 0) 100%);
			background-image: -webkit-linear-gradient(#00ADEE 5%,rgb(2, 217, 12) 100%);
			border-radius: 0.5em;
			border-color:rgb(38, 187, 1);
			color: #FFF;
			cursor: pointer;
			font-weight: bold;
...
<body>
	...
	<aside>
		...
		<div>
			<p align="center">Email :- Pam@gmail.com || Web :- www.holidayInn.com || Phone :- 071-98785894 </p>
		</div>
	</aside>
